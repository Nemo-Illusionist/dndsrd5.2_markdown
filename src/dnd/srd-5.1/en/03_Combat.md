...
**_Escaping a Grapple._** A grappled creature can use its action to escape. To do so, it must succeed on a Strength (Athletics) or Dexterity (Acrobatics) check contested by your Strength (Athletics) check.

**_Moving a Grappled Creature._** When you move, you can drag or carry the grappled creature with you, but your speed is halved, unless the creature is two or more sizes smaller than you.
...
**_Psychic._** Mental abilities such as a mind flayer's psionic blast deal psychic damage.
